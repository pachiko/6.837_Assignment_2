...
public:
	...
	void recursiveComputeBindWorldToJointTransforms(Joint* j, Matrix4f parentT);

	// 2.3.2. Implement this method to compute a per-joint transform from
	// joint space to world space in the CURRENT POSE.
	void updateCurrentJointToWorldTransforms();

	void recursiveUpdateCurrentJointToWorldTransforms(Joint* j, Matrix4f parentT);
